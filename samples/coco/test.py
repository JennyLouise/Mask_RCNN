...
def compute_both_batch_aps(image_ids, dataset, model, config):
    ...
    logging.debug("finished all 5 iterations for these images")
    return class_APs, size_APs, APs, class_overlaps, size_overlaps, overlaps_list, classless_APs, classless_size_APs, classless_size_overlaps, classless_overlaps_list
...
def get_stats(weights_filepath, dataset):
    ...
    class_APs,  size_APs, APs, class_overlaps, size_overlaps, overlaps_list, classless_APs, classless_size_APs, classless_size_overlaps, classless_overlaps_list = compute_both_batch_aps(image_ids, dataset, model, config)
    l1 = []
    ...
    for filename in csv_filenames:
        ...
        if not experiment_in_dataframe(df_filepath, experiment):
            ...
            if os.path.exists(weights_file):
                ...
                experiment["classless_overlaps_list"] = get_stats(weights_file, datasets[0])
                ...
                experiment["classless_size_APs"], \
                experiment["classless_size_overlaps"], \
                experiment["classless_overlaps_list"]  = get_stats(weights_file, datasets[1])
                ...
                experiment["classless_size_APs"], \
                experiment["classless_size_overlaps"], \
                experiment["classless_overlaps_list"]  = get_stats(weights_file, datasets[2])
                ...
                experiment["classless_size_APs"], \
                experiment["classless_size_overlaps"], \
                experiment["classless_overlaps_list"]  = get_stats(weights_file, datasets[3])
                # except:
...
def get_total_pixels_IOU(weights_file, dataset):
